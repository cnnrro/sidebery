...
例：「*」、「ctrl+$」、「ctrl+alt+g」`,
  ...
  'settings.nav_tabs_panel_mid_click_discard_inact': {
    en: 'unload inactive tabs',
    de: 'Inaktive Tabs entladen',
    fr: 'Décharger les onglets inactifs',
    hu: 'Inaktív lapok kisöprése',
    pl: 'Usypiaj nieaktywne karty',
    ru: 'Выгрузить неактивные вкладки',
    zh_CN: '卸载非活动标签页',
    zh_TW: '卸載非作用中分頁',
    ja: '非アクティブなタブをアンロードする',
  },
